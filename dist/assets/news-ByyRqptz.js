import{d as a,c as o}from"./vendor-CwkJpvsb.js";import{a as s}from"./index-DwypnM93.js";const d=a("news",{state:()=>{const e=s();return{language:o(()=>e.language),news:{zh:[{id:1,title:"朗德智能成功研发新一代反无人机系统，拦截距离突破10公里",category:"company",categoryName:"公司新闻",date:"2024-06-10",image:"/images/about/logo-ld.png",summary:'朗德智能宣布其新一代反无人机系统"天盾-X"成功通过最终测试，拦截距离突破10公里大关，成为国内领先的反无人机解决方案。',content:`
            ...
            `},{id:2,title:"朗德智能与国家电网达成战略合作，无人机巡检覆盖五省电力设施",category:"company",categoryName:"公司新闻",date:"2024-05-22",image:"/images/about/logo-ld.png",summary:"朗德智能与国家电网签署战略合作协议，将在五省区域部署智能无人机巡检系统，实现电力设施的智能化、自动化巡检。",content:`
            ...
            `}],en:[{id:1,title:"Lande Intelligent Successfully Develops New Generation of Anti-Drone System with 10KM Interception Range",category:"company",categoryName:"Company News",date:"2024-06-10",image:"/images/about/logo-ld.png",summary:'Lande Intelligent announces its new generation anti-drone system "Sky Shield-X" has successfully passed final testing, with interception distance breaking the 10-kilometer mark, becoming the leading anti-drone solution in China.',content:`
            ...
            `},{id:2,title:"Lande Intelligent Reaches Strategic Cooperation with State Grid, Drone Inspection to Cover Power Facilities in Five Provinces",category:"company",categoryName:"Company News",date:"2024-05-22",image:"/images/about/logo-ld.png",summary:"Lande Intelligent signs strategic cooperation agreement with State Grid to deploy intelligent drone inspection systems in five provinces, achieving intelligent and automated inspection of power facilities.",content:`
            ...
            `}]},categories:{zh:[{id:"all",name:"全部"},{id:"company",name:"公司新闻"},{id:"industry",name:"行业动态"},{id:"media",name:"媒体报道"},{id:"blog",name:"技术博客"}],en:[{id:"all",name:"All"},{id:"company",name:"Company News"},{id:"industry",name:"Industry Updates"},{id:"media",name:"Media Coverage"},{id:"blog",name:"Tech Blog"}]}}},getters:{getAllNews(e){return e.news[e.language]||e.news.zh},getNewsByCategory:e=>t=>{const n=e.news[e.language]||e.news.zh;return t==="all"?n:n.filter(i=>i.category===t)},getNewsById:e=>t=>(e.news[e.language]||e.news.zh).find(i=>i.id===parseInt(t)),getCategories(e){return e.categories[e.language]||e.categories.zh}}});export{d as u};
