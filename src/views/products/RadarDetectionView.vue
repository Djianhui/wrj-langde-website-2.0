    ...
    <div class="product-hero">
      <div class="container">
        ...
        <div class="product-hero-content">
          <h1 class="product-title">雷达探测系统</h1>
    ...
    <div class="container">
      ...
      <div class="product-overview">
        <div class="product-image">
          <img src="/images/products/radar-detection.jpg" alt="雷达探测系统" @error="handleImageError">
        </div>
        <div class="product-info">
          <h2>产品概述</h2>
          <p>采用先进的相控阵雷达技术，实现对小型无人机的精准探测。系统具备毫米级定位精度，毫秒级目标检测响应时间，能够进行实时轨迹预测分析。</p>
          
          <div class="product-specs">
            <h3>技术规格</h3>
            <div class="specs-grid">
              <div class="spec-item">
                <span class="spec-label">探测距离</span>
                <span class="spec-value">5-10km</span>
              </div>
              <div class="spec-item">
              ...
              <div class="spec-item">
                <span class="spec-label">工作频段</span>
                <span class="spec-value">Ku段</span>
              </div>
            </div>
          </div>
        </div>
